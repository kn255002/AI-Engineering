...
def function2():
    ...
    x=np.arange(10,37,dtype=np.float).reshape((3,3,3))
...
def function6():
    ...
    arr=np.zeros((5,2),np.int)#wrtie your code here
    arr[2,0]=10
    arr[3,1]=20  
    return arr
...
def function8():
    ...
    x = np.ones(10,np.int32).reshape(2,5) #write your code here
    x=x*6
    return x
...
def function14():
    ...
    ans=np.arange(10,33+1,1).reshape(8,3) #write reshape code
    ans = ans=np.split(ans,[1,3,5,7]) #write your code here 
...
def function18():
    ...
    x = len(students) # Write you code Here
    return x
...
def function19():
    ...
    b =  (W.T*X)+b =    # Write your code here
